...
interface AllCompletedTasksModalProps {
  open: boolean;
  onClose: () => void;
  tasks: any[];
}

const AllCompletedTasksModal: React.FC<AllCompletedTasksModalProps> = ({ open, onClose, tasks }) => {
...
export default AllCompletedTasksModal; 